...
class Gutenberg extends Base implements Platform {
	...
	public function __construct( $is_enabled ) {
		...
		$this->editor_css_file = $this->add_css_file(
			new CSS_File(
				'automaticcss-gutenberg-editor',
				'automatic-gutenberg-editor.css',
				array(
					'source_file' => 'platforms/gutenberg/automatic-gutenberg-editor.scss',
					'imports_folder' => 'platforms/gutenberg'
				)
			)
		);
		...
		add_action( 'after_setup_theme', array( $this, 'inject_core_stylesheets_in_block_editor' ) );
		add_action( 'after_setup_theme', array( $this, 'add_color_palette' ) );
		if ( is_admin() ) {
	...
	public function enqueue_block_assets() {
		...
		Logger::log( 'Enqueueing Gutenberg block assets.' );
		if ( ! is_admin() ) {
	...
	public function enqueue_block_editor_assets() {
		...
		Logger::log( 'Enqueueing Gutenberg block editor assets.' );
