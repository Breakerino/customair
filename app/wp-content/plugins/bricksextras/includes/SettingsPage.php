	...
	public static function init( $prefix, $title, $version ) {
		...
		<div class="form-plugin-links" style="display: flex;">
			<form method="post" action="options.php" style="width: 100%;">
				...
				<?php if ( true === BricksExtrasLicense::is_activated_license() ) { ?>

					<table class="wp-list-table widefat plugins">
						<thead>
						<tr>
							<td id="cb" class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-1">Toggle All</label><input id="cb-select-all-1" type="checkbox"></td><th scope="col" id="name" class="manage-column column-name column-primary">Toggle All</th><td></td></tr>
						</thead>
						<tbody>
				...
				<?php } else {
					echo 'Activate license to enable elements';
				} ?>
			</form>
