  ...
  public function render() {
    ...
    echo "<ul {$this->render_attributes( '_root' )}>";
		...
		foreach ( $items as $index => $item ) {
			...
			$ariaLabel = isset( $item['ariaLabel'] ) ? $item['ariaLabel'] : false;

			$copiedLabel = isset( $item['copiedLabel'] ) ? $item['copiedLabel'] : false;

			
			$customURL = ! empty( $item['customURL'] ) ? esc_attr( $item['customURL'] ) : '';
			...
			switch ( $item['service'] ) {
				case 'facebook':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on facebook',
						'icon'    => $icon ? $icon : \Bricks\Helpers::get_file_contents( BRICKS_URL_ASSETS . 'svg/frontend/facebook.svg' ),
					];
					break;
				...
				case 'twitter':
					$data = [
						...
						'class'   => 'twitter',
						'label'   => $label ? $label : 'Twitter',
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on twitter',
						'icon'    => $icon ? $icon : \Bricks\Helpers::get_file_contents( BRICKS_URL_ASSETS . 'svg/frontend/twitter.svg' ),
					];
					break;
				...
				case 'linkedin':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on linkedin',
				...
				case 'whatsapp':
					...
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on whatsapp',
				...
				case 'pinterest':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on pinterest',
				...
				case 'telegram':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on telegram',
				...
				case 'vkontakte':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on vkontakte',
				...
				case 'xing':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on xing',
				...
				case 'line':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on Line',
				...
				case 'mastodon':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share on Mastodon',
				...
				case 'custom':
					$data = [
						...
						'ariaLabel'   => $ariaLabel ? $ariaLabel : 'Share',
		...
		//if ( $openPopup ) {
		wp_enqueue_script( 'x-social-share', BRICKSEXTRAS_URL . 'components/assets/js/socialshare.js', '', '1.0.0', true );
		//}
