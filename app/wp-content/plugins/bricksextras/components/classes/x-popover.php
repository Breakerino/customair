...
class X_Popover extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-popper', BRICKSEXTRAS_URL . 'components/assets/js/popper.js', '', '1.0.0', true );
	  wp_enqueue_script( 'x-popover', BRICKSEXTRAS_URL . 'components/assets/js/popover.js', ['x-popper'], '1.0.1', true );
  ...
  public function render() {
    ...
    $ariaLabel = isset( $this->settings['ariaLabel'] ) ? $this->settings['ariaLabel'] : false;
    $buttonText = isset( $this->settings['buttonText'] ) ? $this->settings['buttonText'] : false;
