...
class X_Table_Of_Contents extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
	...
	wp_enqueue_script( 'x-toc', BRICKSEXTRAS_URL . 'components/assets/js/tableofcontents.js', ['x-frontend'], '1.0.2', true );
  }
  ...
  public function render() {
		...
		$aria_label = isset( $this->settings['headerAriaLabel'] ) ? esc_html( $this->settings['headerAriaLabel'] ) : 'Table of Contents';
