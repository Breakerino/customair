...
class X_Dynamic_Chart extends \Bricks\Element {
  ...
  public function set_controls() {
		...
		$this->controls['chart_type'] = [
		  ...
		  $this->controls['datasetLabel'] = [
			...
			'type' => 'text',
			'inline' => true,
			'placeholder' => esc_html__( 'Legend text', 'bricks' ),
  ...
  public function enqueue_scripts() {
	...
	wp_enqueue_script( 'x-chart', BRICKSEXTRAS_URL . 'components/assets/js/dynamicchart.js', '', '1.0.3', true );
  ...
  public function render() {
		...
		$config = [
			...
			'xAxisTitle' => ! empty( $settings['xAxisTitle'] ) ? $settings['xAxisTitle'] : '',
			'yAxisTitle' => ! empty( $settings['yAxisTitle'] ) ? $settings['yAxisTitle'] : '',
			...
			'xAxisUnits' => isset( $settings['xAxisUnits'] ) ? $settings['xAxisUnits'] : '',
			'xAxisUnitPosition' => isset( $settings['xAxisUnitPosition'] ) ? $settings['xAxisUnitPosition'] : 'after',
			'ariaLabel' => isset( $settings['ariaLabel'] ) ? $settings['ariaLabel'] : 'Chart',
		...
		if ( isset( $settings['hasLoop'] ) ) {
			...
			?> <tr> <?php	
				...
				$datasetLabels = ! empty( $settings['datasetLabel'] ) ? $settings['datasetLabel'] : 'Legend text';
