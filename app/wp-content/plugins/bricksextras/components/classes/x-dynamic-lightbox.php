...
class X_Dynamic_Lightbox extends \Bricks\Element {
  ...
  public function set_controls() {
	...
	$this->controls['infoStyling'] = [
		'tab'   => 'content',
		'type'  => 'info',
		'description' => esc_html__( 'Always use classes, not IDs, when styling the lightbox', 'bricksextras' ),
    ];
  ...
  public function enqueue_scripts() {
	...
	wp_enqueue_script( 'x-dynamic-lightbox', BRICKSEXTRAS_URL . 'components/assets/js/dynamiclightbox.js', '', '1.0.9', true );
  ...
  public function render() {
	...
	if ( $images ) {
		...
		foreach ( $images as $index => $item ) {
			...
			$galleryImageURLs[] = $image_src;

		}

		$lightbox_config += ['galleryImages' => $galleryImageURLs];
	}
					...
					<div id="glightbox-slider" class="gslider">
						<div class="gslide current loaded">
							<div class="gslide-inner-content">
								<div v-if="'slider' !== settings.lightboxContent" class="ginner-container">
									<div 
								...
								<div v-else class="ginner-container desc-bottom">
									<div class="gslide-media gslide-image x_lightbox_dummy_content_image" style="max-width: 500px;">
										Image will appear here on the front end.	
									</div>
									<div class="gslide-description description-bottom" style="max-width: 500px;">
										<div class="gdesc-inner">
											<div class="gslide-desc">This is the caption</div>
										</div>
									</div>
								</div>
							</div>
						...
						<button v-if="settings.maybeGrouping" class="gprev gbtn" aria-label="Previous" data-taborder="2"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 477.175 477.175" xml:space="preserve"><g><path d="M145.188,238.575l215.5-215.5c5.3-5.3,5.3-13.8,0-19.1s-13.8-5.3-19.1,0l-225.1,225.1c-5.3,5.3-5.3,13.8,0,19.1l225.1,225c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4c5.3-5.3,5.3-13.8,0-19.1L145.188,238.575z"></path></g></svg></button>
						<button v-if="settings.maybeGrouping" class="gnext gbtn" aria-label="Next" data-taborder="1"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 477.175 477.175" xml:space="preserve"> <g><path d="M360.731,229.075l-225.1-225.1c-5.3-5.3-13.8-5.3-19.1,0s-5.3,13.8,0,19.1l215.5,215.5l-215.5,215.5c-5.3,5.3-5.3,13.8,0,19.1c2.6,2.6,6.1,4,9.5,4c3.4,0,6.9-1.3,9.5-4l225.1-225.1C365.931,242.875,365.931,234.275,360.731,229.075z"></path></g></svg></button>
					</div>
				</div>
			</div>
		</component>		
