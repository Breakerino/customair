...
class X_Before_After_Image extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-before-after-image', BRICKSEXTRAS_URL . 'components/assets/js/beforeafterimage.js', '', '1.0.0', true );
  }
  ...
  public function render() {
    ...
    $beforeText = isset( $this->settings['beforeText'] ) ? $this->settings['beforeText'] : 'Before';
    $afterText = isset( $this->settings['afterText'] ) ? $this->settings['afterText'] : 'After';

    $controlAriaLabel = isset( $this->settings['controlAriaLabel'] ) ? $this->settings['controlAriaLabel'] : 'Percentage of image visible';
