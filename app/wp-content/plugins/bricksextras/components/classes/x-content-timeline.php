...
class X_Content_Timeline extends \Bricks\Element {
  ...
  public function render() {
    ...
    echo "<div {$this->render_attributes( 'x-content-timeline_list' )}>";
    ...
    if ('true' === $horizontal) {
      ...
      wp_enqueue_script( 'x-content-timeline', BRICKSEXTRAS_URL . 'components/assets/js/contenttimeline.js', '', '1.0.2', true );
    }
