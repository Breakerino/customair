...
class X_Back_To_Top extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-backtotop', BRICKSEXTRAS_URL . 'components/assets/js/backtotop.js', '', '1.0.1', true );
  }
  ...
  public function render() {
    ...
    $ariaLabel = isset( $settings['ariaLabel'] ) ? $settings['ariaLabel'] : false;
    $buttonText = isset( $settings['buttonText'] ) ? $settings['buttonText'] : false;
