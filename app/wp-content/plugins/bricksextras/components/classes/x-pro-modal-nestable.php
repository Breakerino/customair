...
class X_Pro_Modal_Nestable extends \Bricks\Element {
	...
	$this->controls['triggers'] = [
		...
		'fields' => [
		  ...
		  'aria_controls' => [
			'tab'   => 'content',
			'small' => true,
			'label' => esc_html__( "Add 'auto-controls' attribute to trigger", 'bricks' ),
			'type'  => 'checkbox',
			'required' => ['type', '=', [
				'elementClick',
			 ]
  ...
  // Methods: Frontend-specific
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'x-pro-modal', BRICKSEXTRAS_URL . 'components/assets/js/promodal.js', '', '1.0.8', true );
