...
class X_Notification_Bar extends \Bricks\Element {
  ...
  public function set_controls() {
    ...
    $this->controls['notification_wysiwyg'] = [
      ...
      'default' => 'Edit me. I am a notification.',
  ...
  public function render() {
    ...
    $dismiss_text = isset( $this->settings['dismissText'] ) ? esc_html( $this->settings['dismissText'] ) : false;
    ...
    if ( 'wysiwyg' === $notification_content ) {
     if ( isset( $this->settings['notification_wysiwyg'] ) ) {
       echo $this->settings['notification_wysiwyg'];
     }
   } else {
