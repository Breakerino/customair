...
class X_Burger_Trigger extends \Bricks\Element {
  ...
  // Element properties
	...
	public function set_controls() {
		...
		$this->controls['burger_scale'] = [
		  ...
		  $this->controls['burger_line_color_active'] = [
			'tab' => 'content',
			'label' => esc_html__( 'Burger line color (active)', 'bricks' ),
			'type' => 'color',
			'inline' => true,
			'css' => [
			  [
	...
	public function render() {
		...
		$aria_label = isset( $this->settings['aria_label'] ) ? esc_attr($this->settings['aria_label']) : 'open menu';
		$buttonText = isset( $this->settings['buttonText'] ) ? esc_attr($this->settings['buttonText']) : '';
