...
class X_Header_Search extends \Bricks\Element {
  ...
  public function set_controls() {
    ...
    $this->controls['layout'] = [
      ...
      $this->controls['aria_label'] = [
        ...
        'group' => 'icons',
        'inline' => true,
        'placeholder' => esc_html__( 'Open search', 'bricks' ),
        ];
      ...
      $this->controls['close_aria_label'] = [
        ...
        'group' => 'icons',
        'inline' => true,
        'placeholder' => esc_html__( 'Close search', 'bricks' ),
        'required' => ['maybe_remove_close', '!=', true]
        ];
  ...
  public function render() {
    ...
    $this->set_attribute( 'x-header-search_toggle-open', 'aria-label', isset( $this->settings['aria_label'] ) ? $this->settings['aria_label'] : 'Open Search' );
    ...
    $this->set_attribute( 'x-header-search_toggle-close', 'aria-label', isset( $this->settings['close_aria_label'] ) ? $this->settings['close_aria_label'] : 'Close Search' );
    ...
    $placeholder = isset( $this->settings['placeholder'] ) ? $this->settings['placeholder'] : 'Search...';
